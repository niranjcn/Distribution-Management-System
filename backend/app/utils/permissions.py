...
PERMISSIONS = {
    "users:read": [SUPER_ADMIN, MD_DIRECTOR, MANAGER, SUB_DISTRIBUTION_MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER],
    "users:create": [SUPER_ADMIN, MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER],
    "users:update": [SUPER_ADMIN, MANAGER],
    "users:delete": [SUPER_ADMIN],
    "users:set_permissions": [SUPER_ADMIN],

    "devices:read": [SUPER_ADMIN, MD_DIRECTOR, MANAGER, PDIC_STAFF, SUB_DISTRIBUTION_MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER, OPERATOR],
    ...
    "distributions:create": [SUPER_ADMIN, MANAGER, PDIC_STAFF, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER, OPERATOR],
    ...
    "defects:create": [SUPER_ADMIN, MANAGER, PDIC_STAFF, SUB_DISTRIBUTION_MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER, OPERATOR],
    ...
    "returns:read": [SUPER_ADMIN, MD_DIRECTOR, MANAGER, PDIC_STAFF, SUB_DISTRIBUTION_MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER, OPERATOR],
    "returns:create": [SUPER_ADMIN, MANAGER, PDIC_STAFF, SUB_DISTRIBUTION_MANAGER, SUB_DISTRIBUTOR, SUB_DISTRIBUTION_EMPLOYEE, CLUSTER, OPERATOR],
