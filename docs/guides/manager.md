...
11. [External inventory (items & distribution)](#11-external-inventory-items--distribution)
    ...
    - [11.6 Step-by-step: bulk upload items from CSV](#116-step-by-step-bulk-upload-items-from-csv)
...
### 11.6 Step-by-step: bulk upload items from CSV
...
2. Open it, replace the samples with your items, and keep the header. The required column
   ...
   `warranty_duration` (months), and `notes`. The same rules as 11.3 apply: an identifier
